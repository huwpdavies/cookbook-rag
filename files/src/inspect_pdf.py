...
def run_poppler_diagnostics(pdf_path: str) -> None:
    print("=" * 60)
    print("PDF METADATA (pdfinfo)")
    print("=" * 60)
    subprocess.run(["pdfinfo", pdf_path], check=False)

    print()
    print("=" * 60)
    print("FONT / TEXT LAYER CHECK (pdffonts)")
    print("=" * 60)
    print("An empty table below means no text layer: the book is scanned")
    print("and will need OCR, not plain text extraction.")
    subprocess.run(["pdffonts", pdf_path], check=False)
...
if __name__ == "__main__":
    ...
    run_poppler_diagnostics(pdf_path)
